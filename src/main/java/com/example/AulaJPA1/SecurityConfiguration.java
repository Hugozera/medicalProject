...
import com.example.AulaJPA1.model.security.UsuarioDetailsConfig;
        ...
        http.authorizeHttpRequests(
                        customizer ->
                                customizer
                                        ...
                                        .requestMatchers("/paciente/listar").hasAnyRole("ADM")
                                        .requestMatchers("/paciente/cadastrar").hasAnyRole("ADM")
                                        .requestMatchers("/medico/listar").hasAnyRole("ADM")
                                        .requestMatchers("/medico/cadastrar").hasAnyRole("ADM")
                                        .requestMatchers("/consulta/listar").hasAnyRole("ADM")
                                        .requestMatchers("/consulta/cadastrar").hasAnyRole("ADM")
